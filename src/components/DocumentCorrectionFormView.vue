...
const templateTypes = [
  { icon: FileCheck, label: '文档纠错', active: true },
  ...
  <div class="correction-form-page">
      ...
      <div class="form-content">
        ...
        <div class="form-group">
          ...
          <div class="template-upload-cards">
            <label class="upload-card">
              ...
              <div class="card-title">点击上传需要纠错的文档</div>
        ...
        <div class="form-group">
          ...
          <textarea 
            ...
            class="form-textarea" 
            placeholder="请输入您的具体需求，如：重点检查法律术语、关注逐级逻辑表达等"
            maxlength="1000"
            rows="6"
          ></textarea>
    ...
    <aside class="info-sidebar">
      <div class="info-card">
        ...
        <h3 class="info-title">文档纠错</h3>
        <p class="info-desc">AI智能诊断，让每一份文档都严谨无瑕</p>
